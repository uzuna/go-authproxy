...
var Assets = assets.NewFileSystem(map[string][]string{"/assets": []string{}, "/assets/html": []string{"error.html.tpl"}, "/": []string{"assets"}}, map[string]*assets.File{
	"/": &assets.File{
		Path:     "/",
		FileMode: 0x800001ff,
		...
		FileMode: 0x1b6,
		Mtime:    time.Unix(1549187152, 1549187152300671600),
